...
function editCliente($conn, $clienteJSON){


$sqlquery ="UPDATE nombre_tabla SET nombre ='" .$clienteJSON->nombre."', apellidos = '" .$clienteJSON->apellidos."', email'" .$clienteJSON->email."', telefono '" .$clienteJSON->telefono."', WHERE nif '" .$clienteJSON->nombre."'";
